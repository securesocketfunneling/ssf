...
macro(boost_build_initialization)
  ...
  elseif("${toolset_name}" STREQUAL "msvc")
    # convert toolset format to boost's
    string(REGEX MATCH "Visual Studio ([0-9]+) [0-9]+" dummy ${CMAKE_GENERATOR})
    if(${CMAKE_MATCH_1} STREQUAL "15")
      set(toolset_name "msvc-14.1")
	else()
	  set(toolset_name "msvc-${CMAKE_MATCH_1}.0")
	endif()
  else()
