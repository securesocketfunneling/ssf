#ifndef SSF_CORE_VIRTUAL_NETWORK_NETWORK_LAYER_NETWORK_ID_H_
#define SSF_CORE_VIRTUAL_NETWORK_NETWORK_LAYER_NETWORK_ID_H_
...
#endif  // SSF_CORE_VIRTUAL_NETWORK_NETWORK_LAYER_NETWORK_ID_H_
