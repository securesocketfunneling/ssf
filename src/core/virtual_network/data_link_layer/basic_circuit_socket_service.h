#ifndef SSF_CORE_VIRTUAL_NETWORK_DATA_LINK_LAYER_BASIC_CIRCUIT_SOCKET_SERVICE_H_
#define SSF_CORE_VIRTUAL_NETWORK_DATA_LINK_LAYER_BASIC_CIRCUIT_SOCKET_SERVICE_H_
...
#endif  // SSF_CORE_VIRTUAL_NETWORK_DATA_LINK_LAYER_BASIC_CIRCUIT_SOCKET_SERVICE_H_
