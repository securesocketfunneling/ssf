#ifndef SSF_CORE_VIRTUAL_NETWORK_DATAGRAM_BASIC_FLAGS_H_
#define SSF_CORE_VIRTUAL_NETWORK_DATAGRAM_BASIC_FLAGS_H_
...
#endif  // SSF_CORE_VIRTUAL_NETWORK_DATAGRAM_BASIC_FLAGS_H_
