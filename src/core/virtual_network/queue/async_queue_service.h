#ifndef SSF_CORE_VIRTUAL_NETWORK_QUEUE_ASYNC_QUEUE_SERVICE_H_
#define SSF_CORE_VIRTUAL_NETWORK_QUEUE_ASYNC_QUEUE_SERVICE_H_
...
#include "common/io/get_op.h"
#include "common/io/push_op.h"
      ...
      while (!impl.p_push_op_queue->empty()) {
        ...
        auto do_complete = [op]() mutable {
          op->complete(boost::system::error_code(
              ssf::error::operation_canceled, ssf::error::get_ssf_category()));
        };
        this->get_io_service().post(do_complete);
      }
...
#endif  // SSF_CORE_VIRTUAL_NETWORK_QUEUE_ASYNC_QUEUE_SERVICE_H_
