#ifndef SSF_CORE_VIRTUAL_NETWORK_QUEUE_SEND_QUEUED_DATAGRAM_SOCKET_H_
#define SSF_CORE_VIRTUAL_NETWORK_QUEUE_SEND_QUEUED_DATAGRAM_SOCKET_H_
...
#endif  // SSF_CORE_VIRTUAL_NETWORK_QUEUE_SEND_QUEUED_DATAGRAM_SOCKET_H_
