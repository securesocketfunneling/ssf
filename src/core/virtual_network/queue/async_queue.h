#ifndef SSF_CORE_VIRTUAL_NETWORK_QUEUE_ASYNC_QUEUE_H_
#define SSF_CORE_VIRTUAL_NETWORK_QUEUE_ASYNC_QUEUE_H_
...
#include "core/virtual_network/queue/async_queue_service.h"
...
#endif  // SSF_CORE_VIRTUAL_NETWORK_QUEUE_ASYNC_QUEUE_H_
