#ifndef SSF_CORE_SYSTEM_BASIC_INTERFACES_COLLECTION_H_
#define SSF_CORE_SYSTEM_BASIC_INTERFACES_COLLECTION_H_
...
#endif  // SSF_CORE_SYSTEM_BASIC_INTERFACES_COLLECTION_H_
