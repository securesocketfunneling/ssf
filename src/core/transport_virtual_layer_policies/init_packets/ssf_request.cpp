...
SSFRequest::SSFRequest(version_field_type version)
    : version_(version) {}

SSFRequest::version_field_type SSFRequest::version() const { return version_; }
...
std::array<boost::asio::mutable_buffer, SSFRequest::field_number> SSFRequest::buffer() {
