...
TEST_F(InterfaceTestFixture, Empty) {
  ...
  ASSERT_EQ(interface_manager.available_sockets.count("simple_lo1"), 1)
      << "simple_lo1 not found in interface manager";
  ASSERT_EQ(interface_manager.available_sockets.count("simple_lo2"), 1)
      << "simple_lo2 not found in interface manager";
  ASSERT_EQ(interface_manager.available_sockets.count("simple_tls_lo1"), 1)
      << "simple_tls_lo1 not found in interface manager";
  ASSERT_EQ(interface_manager.available_sockets.count("simple_tls_lo2"), 1)
      << "simple_tls_lo2 not found in interface manager";
  ASSERT_EQ(interface_manager.available_sockets.count("circuit_lo1"), 1)
      << "circuit_lo1 not found in interface manager";
  ASSERT_EQ(interface_manager.available_sockets.count("circuit_lo2"), 1)
      << "circuit_lo2 not found in interface manager";
  ASSERT_EQ(interface_manager.available_sockets.count("circuit_tls_lo1"), 1)
      << "circuit_tls_lo1 not found in interface manager";
  ASSERT_EQ(interface_manager.available_sockets.count("circuit_tls_lo2"), 1)
