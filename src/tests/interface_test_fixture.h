...
class InterfaceTestFixture : public CircuitTestFixture {
 protected:
  using SimpleLinkProtocol = virtual_network::physical_layer::TCPPhysicalLayer;
 ...
 protected:
  ...
  virtual void SetUp() {
    ...
    virtual_network::LayerParameters simple1_acceptor_physical_parameters;
    simple1_acceptor_physical_parameters["port"] = "6000";
    virtual_network::ParameterStack simple1_parameters;
    ...
    virtual_network::LayerParameters simple2_connect_physical_parameters;
    simple2_connect_physical_parameters["addr"] = "127.0.0.1";
    simple2_connect_physical_parameters["port"] = "6000";
    virtual_network::ParameterStack simple2_parameters;
    ...
    virtual_network::LayerParameters simple_tls1_acceptor_physical_parameters;
    simple_tls1_acceptor_physical_parameters["port"] = "5000";
    virtual_network::ParameterStack simple_tls1_parameters;
    ...
    auto simple_tls1_local_endpoint_it =
        simple_tls_resolver.resolve(simple_tls1_parameters, ec);
    ...
    virtual_network::LayerParameters simple_tls2_client_physical_parameters;
    simple_tls2_client_physical_parameters["addr"] = "127.0.0.1";
    simple_tls2_client_physical_parameters["port"] = "5000";
    virtual_network::ParameterStack simple_tls2_parameters;
    ...
    auto simple_tls2_remote_endpoint_it =
        simple_tls_resolver.resolve(simple_tls2_parameters, ec);
    ...
    virtual_network::LayerParameters circuit1_acceptor_physical_parameters;
    circuit1_acceptor_physical_parameters["port"] = "7002";
    virtual_network::ParameterStack pre_circuit1_parameters;
    pre_circuit1_parameters.push_back(circuit1_acceptor_physical_parameters);
    virtual_network::ParameterStack circuit1_parameters(
        virtual_network::data_link_layer::make_acceptor_parameter_stack(
            "server", pre_circuit1_parameters));
    ...
    virtual_network::LayerParameters circuit2_client_physical_parameters;
    ...
    virtual_network::ParameterStack circuit2_parameters(
    ...
    virtual_network::LayerParameters circuit_tls1_acceptor_physical_parameters;
    circuit_tls1_acceptor_physical_parameters["port"] = "8002";
    virtual_network::ParameterStack pre_circuit_tls1_parameters;
    pre_circuit_tls1_parameters.push_back(
        tests::virtual_network_helpers::tls_server_parameters);
    pre_circuit_tls1_parameters.push_back(
        circuit_tls1_acceptor_physical_parameters);
    virtual_network::ParameterStack circuit_tls1_parameters(
        virtual_network::data_link_layer::make_acceptor_parameter_stack(
            "server_tls", pre_circuit_tls1_parameters));
    auto circuit_tls1_local_endpoint_it =
        circuit_tls_resolver.resolve(circuit_tls1_parameters, ec);
    ...
    virtual_network::LayerParameters circuit_tls2_client_physical_parameters;
    circuit_tls2_client_physical_parameters["addr"] = "127.0.0.1";
    circuit_tls2_client_physical_parameters["port"] = "8002";
    virtual_network::data_link_layer::NodeParameterList nodes_tls(
    ...
    virtual_network::ParameterStack circuit_tls2_parameters(
        virtual_network::data_link_layer::
            make_client_full_circuit_parameter_stack("server_tls", nodes_tls));
    auto circuit_tls2_local_endpoint_it =
        circuit_tls_resolver.resolve(circuit_tls2_parameters, ec);
