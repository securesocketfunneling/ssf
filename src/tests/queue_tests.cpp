...
#include "core/virtual_network/queue/async_queue.h"
#include "core/virtual_network/queue/send_queued_datagram_socket.h"

TEST(QueueTest, async_queue_limit_test) {
  boost::asio::io_service io_service;

  typedef virtual_network::queue::basic_async_queue<
...
TEST(QueueTest, async_queue_spawn_test) {
 ...
 TEST(QueueTest, send_queued_datagram_socket) {
  ...
  typedef virtual_network::queue::basic_send_queued_datagram_socket<
