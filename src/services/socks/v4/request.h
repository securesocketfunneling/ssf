#ifndef SSF_SERVICES_SOCKS_V4_REQUEST_H_
#define SSF_SERVICES_SOCKS_V4_REQUEST_H_
...
class Request {
 public:
  enum CommandId { kConnect = 0x01, kBind = 0x02 };
...
#endif  // SSF_SERVICES_SOCKS_V4_REQUEST_H_
