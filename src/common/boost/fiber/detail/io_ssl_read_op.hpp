//
// fiber/detail/io_ssl_read_op.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~
//
// Copyright (c) 2014-2015
//

#ifndef SSF_COMMON_BOOST_ASIO_FIBER_DETAIL_IO_SSL_READ_OP_HPP_
#define SSF_COMMON_BOOST_ASIO_FIBER_DETAIL_IO_SSL_READ_OP_HPP_
...
/// Class to store buffers and read operations on ssl stream
/**
...
class pending_ssl_read_operation : public basic_pending_ssl_operation
{
public:
  BOOST_ASIO_DEFINE_HANDLER_PTR(pending_ssl_read_operation);
  ...
  */
  pending_ssl_read_operation(const MutableBufferSequence& buffers,
                              const Handler& handler)
                              : basic_pending_ssl_operation(&pending_ssl_read_operation::do_complete,
                              &pending_ssl_read_operation::do_fill_buffers),
                              buffers_(buffers),
                              handler_(handler)
  {
  }
  ...
  */
  static void do_complete(basic_pending_io_operation* base,
                          bool destroy,
                          ...
                          std::size_t bytes_transferred)
  {
    ...
    pending_ssl_read_operation* o(static_cast<pending_ssl_read_operation*>(base));
    ...
    boost::asio::detail::binder2<Handler, boost::system::error_code, size_t> handler(
  ...
  static size_t do_fill_buffers(basic_pending_ssl_operation* base,
...
#endif  // SSF_COMMON_BOOST_ASIO_FIBER_DETAIL_IO_SSL_READ_OP_HPP_
